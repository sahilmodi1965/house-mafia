/**
 * Spectator view — read-only screen for players who join a room after
 * the game has already started (issue #35).
 *
 * The shared room channel is already subscribed by room.js when this
 * runs. We attach listeners for the existing phase broadcasts
 * (phase:night-start, phase:night-end, phase:day-discuss, phase:day-vote,
 * game:end) and re-render the current phase label + rosters on every
 * update. No inputs, no timers, no game state ownership.
 */
